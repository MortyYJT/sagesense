# 4:30 pitch and demo script

## 0:00–0:20 — Problem

Show the older-adult persona receiving an official-looking urgent message. Explain that the difficult moment is not only detection; it is understanding why the contact is dangerous and what to do without panic.

## 0:20–0:40 — Blueprint and divergence

Credit Billy Hermawan's Sixth Sense Product-thon blueprint. Show the retained low-density, large-type safety companion and explain the Android-first, warning-only, privacy-first changes.
...
Return to the persona: SageSense turns an alarming contact into a calm, explainable decision. Credit the original designer and name all five team members.

Recording target: 1080p H.264, English narration, English subtitles, selected bilingual UI. Upload as a publicly viewable unlisted video and verify in a logged-out browser.
